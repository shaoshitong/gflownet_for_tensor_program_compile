...
python distributed_measure_candidates_meta_schedule.py --target "nvidia/nvidia-a100" --candidate_cache_dir ./dataset/sample_candidate --result_cache_dir ./dataset/measure_candidate