...
if __name__ == "__main__":
    ...
    # workload_paths0 = glob.glob(os.path.join(
    #     info_path, f"workloads*.json"), recursive=True)
    # candidate_paths0 = [workload_path.replace(
    #     "workloads", "candidates") for workload_path in workload_paths0]
    ...
    for ep in (pbar):
        ...
        if True:
            ...
            cost_model.eval()
            features, _ = extract_features(context00, candidates00)
