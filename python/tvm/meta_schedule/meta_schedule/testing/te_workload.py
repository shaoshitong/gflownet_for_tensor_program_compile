...
def conv2d_winograd_nhwc(  # pylint: disable=invalid-name,missing-docstring
    ...
    from tvm.topi.nn.conv2d import \
        _conv2d_winograd_nhwc_impl  # pylint: disable=import-outside-toplevel
...
def conv2d_winograd_nchw(  # pylint: disable=invalid-name,missing-docstring
    ...
    from tvm.topi.cuda.conv2d_winograd import \
        _infer_tile_size  # pylint: disable=import-outside-toplevel
    from tvm.topi.nn.conv2d import \
        _conv2d_winograd_nchw_impl  # pylint: disable=import-outside-toplevel
