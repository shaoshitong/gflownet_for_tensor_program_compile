...
def handle_file(file_idx, file):
    ...
    return (file, file_idx, workloadkey_idx, task.workload_key, workload_args, task.compute_dag.flop_ct, line_vecs) # 返回结果，包括文件名、文件索引、workloadkey索引、workload_key、workload参数、计算DAG的浮点操作计数和line_vecs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_files_path", type=str, default='dataset_cpu/measure_records/e5-2673-v2')
